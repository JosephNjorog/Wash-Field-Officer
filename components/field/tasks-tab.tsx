...
import { Droplet, Waves, GitBranch, ShowerHead, MapPin, Check } from "lucide-react";
...
export function TasksTab() {
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm font-semibold text-foreground">Today&apos;s Assigned Sites</p>
      ...
      {taskAssets.length === 0 && (
        <p className="text-sm text-muted-foreground">No sites assigned for today.</p>
      )}
    </div>
  );
}
